-- StyleSync Database Migration Script
-- This script migrates the database to the new schema with Shopify Public IDs
...
CREATE INDEX IF NOT EXISTS idx_user_feed_items_user_id_created ON user_feed_items(user_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_story_notifications_user_id ON story_notifications(user_id);
CREATE INDEX IF NOT EXISTS idx_story_notifications_actor_id ON story_notifications(actor_id);
